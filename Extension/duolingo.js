    ...
    chrome.storage.local.get(["ManualButton"], function (res) {
        if (res.ManualButton == true) {
            ...
            chrome.storage.local.get(["Theme"], function (res) {
                if (res.Theme === "blue") {
                    setProperty('#607d8b', '#67a8ba','#4a4848', '#000000', '#69b2c8')
                } else if (res.Theme === "green") {
                    setProperty('#4a7e4a','#50a84a', '#4a4848', 'black', '#37bc8b')
                } else if (res.Theme === "yellow") {
                    setProperty('#9ea24c','#c2d178', '#4a4848', '#6c3e19', '#e05436')
                } else if (res.Theme === "white") {
                    setProperty('white','#5f5f5f', '#afafaf', '#3c3c3c', "#d2d4d6")
                } else { // Dark
                    setProperty('#262626','#343434', '#cbcbcb', '#4e89e3', '#484a4e')
                }
            });
        }
    });
...
function setProperty(BackGroundColor, BackGroundColorSecond, TextColor, TextHeaderColor, SelectedItem) {
